 ...
 *
 */
public class WheelSpeedCalculationsRight extends Subsystem {

	//Instance Handling
    private static WheelSpeedCalculationsRight m_pInstance;
    /**
     ...
     * 
     * @return the reference to the class refered to in GetInstance. In this case, WheelSpeedCalculationsRight.
     */
    public static WheelSpeedCalculationsRight GetInstance()
    {
    	if(m_pInstance == null) m_pInstance = new WheelSpeedCalculationsRight();
    	return m_pInstance;
    }
	...
	private static final String FILEPATH = "home/lvuser/speed-storage-right.ini";

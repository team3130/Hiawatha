 ...
 *
 */
public class IndexMotorLeft extends Subsystem {

	//Instance Handling
    private static IndexMotorLeft m_pInstance;
    /**
     ...
     */
    public static IndexMotorLeft GetInstance()
    {
    	if(m_pInstance == null) m_pInstance = new IndexMotorLeft();
    	return m_pInstance;
    }
    ...
    private IndexMotorLeft()
    {
    	//instantiate necessary objects
    	m_indexMotor = new CANTalon(RobotMap.CAN_INDEXMOTORLEFT);
    	LiveWindow.addActuator("Index", "Index Motor Left", m_indexMotor);
    }
